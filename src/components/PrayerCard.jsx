...
const PrayerCard = ({ prayerTimes, currentPrayer, nextPrayer, location, countdown }) => {
  ...
  return (
    <div className="relative w-[320px] h-[600px] rounded-2xl bg-gradient-to-r from-[#2CA95C] to-[#1F7EC2] text-white font-[Biryani] shadow-lg">
      ...
      {/* White Box for Prayer Times */}
      {/* White Box Layer */}
<div className="absolute top-[180px] left-[10px] w-[300px] h-[400px] bg-white rounded-2xl text-black px-4 py-4 shadow-lg">
